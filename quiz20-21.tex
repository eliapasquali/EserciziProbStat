...
\begin{document}
\begin{center}
    {\Large\textbf{Probabilità e Statistica}}
\end{center}
Questa è una raccolta di esercizi dei questionari online. Le risposte sono corrette prese dalle soluzioni.\\

\section*{Primo questionario}
