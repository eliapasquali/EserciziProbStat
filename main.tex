...
\begin{itemize}
    ...
    \item Gli eventi $E_1$, $E_2$, $E_3$ ed $E_\ge$ non sono una partizione (Risposta corretta)
\end{itemize}
...
\begin{itemize}
    ...
    \item Nessuna delle altre risposte
    \item $\frac{12}{91}$
    \item $\frac{6}{2}$ (Risposta Corretta)
\end{itemize}
...
\textbf{Esercizio 14}\\
Un'urna contiene 2 palline rosse, 3 palline gialle e 2 palline blu. Pesco due palline \textit{con reinserimento}. Qual è la probabilità che la pallina sia blu?
\begin{itemize}
    \item $\frac{1}{2}$
    \item $\frac{10}{21}$
    \item $\frac{20}{21}$
...
Siano $A, B$ eventi tali che $P(A)=0.2, P(B)=0.3$. Quanl è la probabilità dell'evento $A\cup B$?
\begin{itemize}
    \item $0.5$
    \item $0.66$
    \item $0.44$
